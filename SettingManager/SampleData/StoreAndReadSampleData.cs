...
//			SampleDataStore.Admin.Path.SubFolders = new [] { "SettingsManagerData" };
			...
			SampleDataStore.Admin.Path.RootFolderPath =  @"B:\Programming\VisualStudioProjects\SettingsManager\SettingsManagerV70\SettingsManagerData";
