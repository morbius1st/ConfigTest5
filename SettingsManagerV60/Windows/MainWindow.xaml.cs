...
//			testData();
		...
		private void testData3()
		{
			...
			ds.Configure(
				@"B:\Programming\VisualStudioProjects\SettingsManager\SettingsManagerV60\SettingsManagerData",
				@"SampleData2.xml"
				);
...
//			testReset();
		...
		{
			UserSettings.Data.UserSettingsValue = 600;
		...
		{
			SiteSettings.Data.SiteSettingsValue = 603;
		...
		{
			MachSettings.Data.MachSettingsValue = 602;
		...
		{
//			AppSettings.Data.AppSettingsValue = 601;
		...
		{
			MsgLeftLine("");
//			MsgLeftLine("app test", AppSettings.Data.AppSettingsValue.ToString());
