...
//
	...
	public abstract class SiteSettingBase : SettingBase
	{
		public SiteSettingBase()
		{
			Initialize();
		}

		private PathAndFile.SitePathAndFile paf  = new PathAndFile.SitePathAndFile();
//		private PathAndFile.SitePathAndFile paf;

		public new bool IsReadOnly => true;
		public new bool PathGetsAssigned => true;
		public override bool Exists                      => paf.Exists;
		public override string SettingPath               => paf.SettingPath;
		public override string SettingPathAndFile        => paf.SettingPathAndFile;
		public override string FileName                  => paf.FileName;
		public override string[] SubFolders              => paf.SubFolders;
		public override string ClassVersionFromFile      => paf.ClassVersionFromFile;
		public override string SystemVersionFromFile     => paf.SystemVersionFromFile;
		public override bool ClassVersionsMatch          => Header.ClassVersion.Equals(ClassVersionFromFile);
		public override string RootPath                  => paf.RootPath;

		public string SetRootPath
		{
			set { paf.RootPath = value; }
		}
		public override Heading.SettingFileType FileType => Heading.SettingFileType.SITE;

		public override void Initialize()
		{
			paf  = new PathAndFile.SitePathAndFile();
